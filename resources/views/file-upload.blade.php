  ...
  @csrf   {{-- important this is token in laravel and selfly --}}
    ...
    <table>
      <tbody>
        ...
        {{-- <td><img style="width:100px" src="/uploads/{{ $file->file_path }}" alt=""></td> tidak rekomendasi--}}
    ...
    <div>
      <button type="submit" class="text-white bg-blue-100 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 mt-3" value="{{ old('file') }}">Submit</button>
    </div>
  </form>
</section>
